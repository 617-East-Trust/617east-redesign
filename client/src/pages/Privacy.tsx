          ...
          <div className="space-y-10" style={{ color: "oklch(0.62 0.010 80)" }}>
            {[
              ...
              },
              {
                ...
                body: "We use first-party analytics operated by 617 East Trust (self-hosted event pipeline), Google Tag Manager / Google Analytics (Google LLC), and Microsoft Clarity (Microsoft Corporation) to understand how visitors use this website. First-party analytics may include page views, clicks, scroll depth, form interaction metadata (field names/types/lengths only — not values), device and browser class, UTM attribution, and approximate location derived from IP on our servers. Google Analytics collects usage data such as pages visited, time on site, and traffic sources. Microsoft Clarity records session replays and heatmaps to identify usability issues. Device fingerprint signals (Canvas/WebGL) are collected when you accept analytics consent; they are not collected if you decline. We do not sell personal data. Analytics scripts and first-party event collection load only after cookie consent. You may opt out of Google Analytics at https://tools.google.com/dlpage/gaoptout and Microsoft Clarity at https://privacy.microsoft.com."
              },
              {
                title: "Cookies and Consent",
                body: "This website uses cookies and local storage for analytics purposes (first-party analytics, Google Tag Manager / Analytics, and Microsoft Clarity). Optional call-tracking scripts (e.g. CallRail) load only after consent when configured. A consent banner is displayed on your first visit. If you accept, analytics cookies are set, third-party tracking scripts are loaded, and first-party analytics events (including device fingerprint signals) are sent. If you decline, no analytics cookies are set, no third-party tracking scripts are loaded, and no first-party analytics events are sent. Your consent preference is stored in your browser's localStorage and expires when you clear your browser data. You may change your preference at any time by clearing your browser's localStorage for 617east.com."
              },
              {
